/// updated : 1671367598016
/// cases : 657676953
/// todayCases : 242000
/// deaths : 6671702
/// todayDeaths : 452
/// recovered : 631365093
/// todayRecovered : 134487
/// active : 19640158
/// critical : 38134
/// casesPerOneMillion : 84374
/// deathsPerOneMillion : 855.9
/// tests : 6866654139
/// testsPerOneMillion : 864280.86
/// population : 7944933753
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2472.04
/// recoveredPerOneMillion : 79467.63
...
class Allcasesmodel {
  ...
  Allcasesmodel.fromJson(dynamic json) {
...
Allcasesmodel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => Allcasesmodel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
